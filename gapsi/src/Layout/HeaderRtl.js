  ...
  return (<>
    ...
    <Row gutter={[24, 0]}>
      ...
      <Col span={24} md={18} className="header-control">
        ...
        <Drawer
          rootClassName="settings-drawer settings-drawer-rtl"
          mask={true}
          width={360}
          onClose={hideDrawer}
          placement={placement}
        ...
        >
          <div layout="vertical">
            <div rootClassName="header-top">
              <Title level={4}>
                Configurator
                <Text rootClassName="subtitle">See our dashboard options.</Text>
              </Title>
            </div>

            <div rootClassName="sidebar-color">
              <Title level={5}>Sidebar Color</Title>
              <div rootClassName="theme-color mb-2">
                <ButtonContainer>
                  <Button
                    type="primary"
              ...
              <div rootClassName="sidebarnav-color mb-2">
                <Title level={5}>Sidenav Type</Title>
                <Text>Choose between 2 different sidenav types.</Text>
                <ButtonContainer rootClassName="trans">
                  <Button
              ...
              <div rootClassName="fixed-nav mb-2">
                <Title level={5}>Navbar Fixed </Title>
                <Switch onChange={(e) => handleFixedNavbar(e)} />
              </div>
              <div rootClassName="ant-docment">
                <ButtonContainer>
              ...
              <div rootClassName="viewstar">
                <a href="#pablo">{<StarOutlined />} Star</a>
                <a href="#pablo"> 190</a>
              </div>

              <div rootClassName="ant-thank">
                <Title level={5} rootClassName="mb-2">
                  Thank you for sharing!
                </Title>
                <ButtonContainer rootClassName="social">
